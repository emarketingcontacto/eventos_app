@extends('layouts.app')
    @section('seo')
        {{-- seo --}}
            <title>Renta de Inflables en Leon | Brincolines cerca de mi | Todo Fiestas León </title>
            <meta name="description" content="Renta de inflables y brincolines en León. 🏰 Castillos y toboganes limpios y seguros para tu fiesta. ¡Servicio cerca de tu ubicación. Cotiza hoy!">
            <link rel="canonical" href="{{ url()->current() }}">
            <meta property="og:title" content=" Todo Fiestas León - Renta de Inflables">
            <meta property="og:image" content="{{ asset('images/party-1.jpg') }}">
        {{-- seo --}}
    @endsection
    ...
    @section('content')
        <!-- Hero Section -->
            <header class="relative bg-blue-300 py-16 md:py-24 overflow-hidden">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div class="grid md:grid-cols-2 gap-12 items-center">
                        <div class="text-white">
                            <h1 class="text-4xl md:text-6xl font-extrabold leading-tight mb-6">
                                Renta de <span class="text-blue-700 italic font-black underline">Inflables - Brincolines</span> en León
                            </h1>
                            <h2 class="text-lg md:text-xl mb-8 opacity-90 text-slate-700" >
                                 Los Mejores Juegos Inflables cerca de tu ubicación en León
                                 Diversión Segura con nuestros Brincolines e Inflables para Fiestas
                                 Justo lo que necesitas para tu evento.
                            </h2>
                            <div class="flex flex-col sm:flex-row gap-4">
                                @include('partials.whatsapp-button',['servicio'=>'Inflables'])
                            </div>
                        </div>
